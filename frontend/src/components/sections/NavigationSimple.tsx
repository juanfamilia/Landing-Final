          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-siete-navy to-siete-teal text-white px-6 py-2 rounded-full font-semibold hover:shadow-lg transition-all"
              >
                {t.requestDemo}
              </button>
            </div>
            ...
            <div className="md:hidden border-t border-gray-200 bg-white">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <div className="px-3 pt-2 border-t border-gray-200">
                  ...
                  <button
                    onClick={openDemoForm}
                    className="w-full bg-gradient-to-r from-siete-navy to-siete-teal text-white rounded-full font-semibold py-2"
                  >
                    {t.requestDemo}
                  </button>
                </div>
